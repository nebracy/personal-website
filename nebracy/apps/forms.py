...
class DoughCalculatorForm(FlaskForm):
    ...
    dough_weight = DecimalField('Dough Weight', validators=[Optional(), NumberRange(1, 20000)])
    g_oz = RadioField('Grams/Ounces', choices=['oz', 'grams'], default='grams', validators=[Optional()])
